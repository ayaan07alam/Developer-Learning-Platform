        ...
        try {
            ...
            if (response.ok) {
                ...
                setFormData({
                    ...
                    publishImmediately: data.status === 'ACTIVE',
                });
            } else {
                setError('Failed to load job details. The job may not exist or you may not have permission to edit it.');
            }
        } catch (err) {
        ...
        <div className="min-h-screen pt-24 pb-12 bg-background">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">Update the details of your job listing</p>
                </div>
                    ...
                    <div className="p-6 rounded-xl bg-secondary/5 border border-border space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <label htmlFor="publish" className="text-sm">
                                Keep job active (uncheck to close the listing)
                            </label>
                        </div>
                    </div>
