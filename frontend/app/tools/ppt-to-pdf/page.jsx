        ...
        <div className="min-h-screen bg-background pt-24 pb-12">
            <div className="container mx-auto px-6 max-w-3xl">
                ...
                >
                    ...
                    <h1 className="text-4xl font-bold mb-3">PPT to PDF</h1>
                ...
                {!file ? (
                    ...
                    <div className="space-y-6">
                        <div className="p-6 rounded-xl bg-card border border-border flex items-center gap-3">
                            <Presentation className="w-10 h-10 text-red-500" />
                            <div>
                        ...
                        <div className="p-6 rounded-xl bg-yellow-500/10 border border-yellow-500/50">
                            <p className="text-sm text-muted-foreground mb-4">
                                <strong>Feature Under Development:</strong> PPT to PDF requires Apache POI and PDFBox.
