...
const TermsOfService = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mt-4">
        We are IntelForgeeks("Company," "we," "us," "our"). We operate , as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p className="mt-4">
        You can contact us by email at IntelForgeeks.
      </p>
      <p className="mt-4">
      ...
      <ol className="list-decimal ml-8 mt-4 space-y-2">
        <li><a href="#section-1" className="text-primary">OUR SERVICES</a></li>
        <li><a href="#section-2" className="text-primary">INTELLECTUAL PROPERTY RIGHTS</a></li>
        <li><a href="#section-3" className="text-primary">USER REPRESENTATIONS</a></li>
        <li><a href="#section-4" className="text-primary">PROHIBITED ACTIVITIES</a></li>
        <li><a href="#section-5" className="text-primary">USER GENERATED CONTRIBUTIONS</a></li>
        <li><a href="#section-6" className="text-primary">CONTRIBUTION LICENSE</a></li>
        <li><a href="#section-7" className="text-primary">SERVICES MANAGEMENT</a></li>
        <li><a href="#section-8" className="text-primary">TERM AND TERMINATION</a></li>
        <li><a href="#section-9" className="text-primary">MODIFICATIONS AND INTERRUPTIONS</a></li>
        <li><a href="#section-10" className="text-primary">GOVERNING LAW</a></li>
        <li><a href="#section-11" className="text-primary">DISPUTE RESOLUTION</a></li>
        <li><a href="#section-12" className="text-primary">CORRECTIONS</a></li>
        <li><a href="#section-13" className="text-primary">DISCLAIMER</a></li>
        <li><a href="#section-14" className="text-primary">LIMITATIONS OF LIABILITY</a></li>
        <li><a href="#section-15" className="text-primary">INDEMNIFICATION</a></li>
        <li><a href="#section-16" className="text-primary">USER DATA</a></li>
        <li><a href="#section-17" className="text-primary">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
        <li><a href="#section-18" className="text-primary">MISCELLANEOUS</a></li>
        <li><a href="#section-19" className="text-primary">CONTACT US</a></li>
      </ol>
