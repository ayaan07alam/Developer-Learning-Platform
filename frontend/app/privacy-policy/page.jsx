...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <ul className="list-disc ml-8 mt-4">
                <li>
                    <strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. <a href="#section-1" className="text-primary hover:underline">Learn more</a>.
                </li>
                <li>
                    <strong>Do we process any sensitive personal information?</strong> We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law. <a href="#section-1" className="text-primary hover:underline">Learn more</a>.
                </li>
                <li>
                    <strong>Do we collect any information from third parties?</strong> We do not collect any information from third parties.
                </li>
                <li>
                    <strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. <a href="#section-2" className="text-primary hover:underline">Learn more</a>.
                </li>
                <li>
                    <strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. <a href="#section-4" className="text-primary hover:underline">Learn more</a>.
                </li>
                <li>
                ...
                <li>
                    <strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. <a href="#section-9" className="text-primary hover:underline">Learn more</a>.
                </li>
                <li>
            ...
            <ol className="list-decimal ml-8 mt-4 space-y-1">
                ...
                <li><a href="#section-5" className="text-primary hover:underline">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a></li>
                <li><a href="#section-6" className="text-primary hover:underline">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
                <li><a href="#section-7" className="text-primary hover:underline">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
                <li><a href="#section-8" className="text-primary hover:underline">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
                ...
                <li><a href="#section-11" className="text-primary hover:underline">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
                <li><a href="#section-12" className="text-primary hover:underline">DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
                <li><a href="#section-13" className="text-primary hover:underline">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
                <li><a href="#section-14" className="text-primary hover:underline">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
                <li><a href="#section-15" className="text-primary hover:underline">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
            </ol>
            ...
            <ul className="list-disc ml-8 mt-4">
                <li>
                    <strong>Log and Usage Data:</strong> Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services.
                </li>
                <li>
            ...
            {/* ... Rest of legal bases section kept simplified for brevity but implying standard GDPR/legal compliance ... */}
            <p className="mt-4">
                If you are located in the EU or UK, this section applies to you. The General Data Protection Regulation (GDPR) and UK GDPR require us to explain the valid legal bases we rely on in order to process your personal information. As such, we may rely on Consent, Legitimate Interests, Legal Obligations, or Vital Interests.
            </p>
            ...
            <ul className="list-disc ml-8 mt-4">
                <li>Ad Networks (such as Google AdSense)</li>
                <li>Cloud Computing Services</li>
                <li>Data Analytics Services (such as Google Analytics)</li>
            </ul>
            ...
            <p className="mt-4">
                The Services may link to third-party websites, online services, or mobile applications and/or contain advertisements from third parties that are not affiliated with us. We are not responsible for the content or privacy and security practices and policies of any third parties.
            </p>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg mt-4 border border-l-4 border-l-primary">
                ...
                <p className="mt-2 text-sm">
                    ...
                    You may opt out of the use of the DoubleClick Cookie for interest-based advertising by visiting the <a href="http://www.google.com/ads/preferences/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google Ads Settings</a> web page.
                </p>
            </div>

            <p className="mt-4">
                <strong>Google Analytics:</strong> We may share your information with Google Analytics to track and analyze the use of the Services. To opt out of being tracked by Google Analytics across the Services, visit <a href="https://tools.google.com/dlpage/gaoptout" className="text-primary hover:underline">https://tools.google.com/dlpage/gaoptout</a>.
            </p>
            ...
            <p className="mt-4">
                <strong>In Short:</strong> We aim to protect your personal information through a system of organizational and technical security measures. However, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure.
            </p>
            ...
            <p className="mt-4">
                <strong>In Short:</strong> You may have additional rights based on the country you reside in, such as Australia, New Zealand, or South Africa.
            </p>

            <h2 id="section-13" className="text-2xl font-semibold mt-8">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            <p className="mt-4">
                <strong>In Short:</strong> Yes, we will update this notice as necessary to stay compliant with relevant laws. The updated version will be indicated by an updated "Revised" date.
            </p>
            ...
            <p className="mt-4">
                Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it under some circumstances. To request to review, update, or delete your personal information, please visit our <Link href="/contact" className="text-primary hover:underline">Contact page</Link> or email us directly.
            </p>
        </div>
    );
};
